...
const Navbar = () => {
  ...
  return (
    <div className='nav-h-52 flex w-full lg:h-[68px]'>
      <nav
        className={`z-10 top-0 flex w-full lg:h-[68px] nav-h-52 border-b-[0.5px] border-b-[#747474aa] justify-between xl:px-[1px] lg:px-[10%] md:px-[56px] nyxContainer fixed  ${
          open ? '' : ''
        } bg-[#070C10]`}
      >
        <div className='nav-y-p flex items-center justify-center pl-[20px] lg:w-[10%] lg:pl-0 xl:w-[10%] xl:pl-0'>
          <a href='#home' className='flex'>
            <div className='app__navbar-p nav-logo-w-h lg:h-[39px] lg:w-[64px] xl:h-[39px] xl:w-[64px]'>
              <svg
                width='100%'
                height='100%'
                viewBox='0 0 42 24'
        ...
        <div className='hidden font-[RobotoMono] text-[15px] xl:ml-auto xl:flex'>
          <ul className='app__navbar-links text-white'>
            <li className='flex items-center justify-center'>
              <a
                href='#toolkit'
                className='relative flex h-[67px] items-center px-2 before:absolute before:bottom-0 before:left-0 before:h-[4px] before:w-full before:origin-right before:scale-x-0 before:bg-gradient-to-r before:from-blue-400 before:to-green-500 before:transition-transform before:duration-300 hover:before:origin-left hover:before:scale-x-100'
              >
            ...
            <li className='flex items-center justify-center'>
              <a
                ...
                className='relative flex h-[67px] items-center px-2 before:absolute before:bottom-0 before:left-0 before:h-[4px] before:w-full before:origin-right before:scale-x-0 before:bg-gradient-to-r before:from-blue-400 before:to-green-500 before:transition-transform before:duration-300 hover:before:origin-left hover:before:scale-x-100'
              >
                <CipherText detail={{ value: 'Exchange Currency' }} />
              </a>
            </li>
            <li className='flex items-center justify-center'>
              <a
        ...
        <div className='ml-auto items-center justify-center gap-4 xl:justify-between'>
          <div className='hidden h-full items-center justify-center gap-4 md:flex lg:flex xl:flex'>
            <a
              href='https://app.nyxcipher.ai'
              rel='noopener noreferrer'
              target='_blank'
            >
              <button className='clipButton w-[130px] font-[Nippo]'>
                Launch App
              </button>
            </a>
        ...
        <div className='ml-4 mr-auto hidden items-center justify-center md:flex lg:flex xl:mx-0 xl:flex xl:w-[10%]'>
        ...
        <div
          className={`flex xl:hidden items-center justify-center xl:pr-0 lg:pr-0  ${
            open ? '' : 'pr-[20px]'
          }`}
        >
          {open ? (
            ...
            <button
              className='app__navbar-p flex items-center justify-center bg-transparent'
      ...
      {open && (
        <div
          className='nav-x-p fixed z-[3] w-full md:w-full lg:w-full xl:w-full'
          style={{ backgroundColor: 'rgb(7,12,16)', transitionDuration: '0s' }}
        >
          <div className='mx-[14px] h-screen overflow-y-scroll border-l-[0.5px] border-r-[0.5px] border-[#747474aa] pt-[50px] sm:mx-[14px] md:mx-[56px]'>
            <div>
              <ul className='app__navbar-smallscreen_links mt-7 pb-10'>
                <li
                  style={{ '--delay': 0 + 's' }}
                  onClick={() => handleOpen(false)}
                  className='relative animate-slideIn border-b-[0.5px] border-[#747474aa] text-xl text-white opacity-0 before:absolute before:bottom-0 before:left-0 before:h-[4px] before:w-full before:origin-right before:scale-x-0 before:bg-gradient-to-r before:from-blue-400 before:to-green-500 before:transition-transform before:duration-300 hover:before:origin-left hover:before:scale-x-100'
                >
                ...
                <li
                  style={{ '--delay': 0.5 + 's' }}
                  onClick={() => handleOpen(false)}
                  className='relative animate-slideIn text-xl text-white opacity-0 before:absolute before:bottom-0 before:left-0 before:h-[4px] before:w-full before:origin-right before:scale-x-0 before:bg-gradient-to-r before:from-blue-400 before:to-green-500 before:transition-transform before:duration-300 hover:before:origin-left hover:before:scale-x-100 md:hidden'
                >
                  <a
                    href='https://app.nyxcipher.ai'
                    rel='noopener noreferrer'
                ...
                <li
                  style={{ '--delay': 0.6 + 's' }}
                  onClick={() => handleOpen(false)}
                  className='relative animate-slideIn p-0 text-xl text-white opacity-0 before:absolute before:bottom-0 before:left-0 before:h-[4px] before:w-full before:origin-right before:scale-x-0 before:bg-gradient-to-r before:from-blue-400 before:to-green-500 before:transition-transform before:duration-300 hover:before:origin-left hover:before:scale-x-100 md:hidden'
                >
                  <a
                    href='#contact'
                ...
                <li
                  style={{ '--delay': 0.7 + 's' }}
                  onClick={() => handleOpen(false)}
                  className='relative animate-slideIn border-b-[0.5px] border-[#747474aa] p-0 text-xl text-white opacity-0 before:absolute before:bottom-0 before:left-0 before:h-[4px] before:w-full before:origin-right before:scale-x-0 before:bg-gradient-to-r before:from-blue-400 before:to-green-500 before:transition-transform before:duration-300 hover:before:origin-left hover:before:scale-x-100 md:hidden'
                >
                  <a
                    href='#contact'
                    className='flex items-center justify-center'
